...
public final class Optimove
{
    ...
    private func handleReport(event:OptimoveEvent, completionHandler: ResultBlockWithError? = nil)
    {
    ...
    public func register(deepLinkResponder responder : OptimoveDeepLinkResponder)
    {
    ...
    public func unregister(deepLinkResponder responder : OptimoveDeepLinkResponder)
    {
    ...
    public func setScreenEvent(viewControllersIdetifiers:[String],url: URL?)
    {
    ...
    ///   - event: optimove event object
    ///   - completionHandler: A block object to be executed when the report sequence ends. This block has no return value and takes a single Error argument that indicates whether or not the report actually finished before the completion handler was called. This parameter may be nil.
    public func reportEvent(event:OptimoveEvent, completionHandler: ResultBlockWithError? = nil)
    {
