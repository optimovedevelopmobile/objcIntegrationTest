...
protocol SetUserId :OptimoveEvent {
    
}
extension OptimoveEvent where Self:SetUserId {
    var parameters: [String : Any]
    {
...
struct BeforeSetUserId: SetUserId
{
    var name: String
    {
...
struct AfterSetUserId: SetUserId
{
    var name: String
    {
...
protocol Opt :OptimoveEvent {
    
}
extension OptimoveEvent where Self:Opt {
    var parameters: [String : Any]
    {
...
public struct ScreenName: OptimoveEvent
{
